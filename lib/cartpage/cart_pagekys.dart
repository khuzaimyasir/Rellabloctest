...
import 'package:online_shop_app/cartpage/widgets/cart_product_card.dart';
...
class CartPagekys extends StatefulWidget {
  final Recipe product;
  final List<Recipe> list;
  const CartPagekys({Key? key, required this.product, required this.list}) : super(key: key);

  @override
  _CartPageState createState() => _CartPageState();
}

class _CartPageState extends State<CartPagekys> {
