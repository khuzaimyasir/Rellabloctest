  ...
  child: Row(
    ...
    children: [
      Column(
        ...
        children:  [
          AppLargeText(text: "Tracker",color: Colors.grey,),
          const SizedBox(
            height: 5,
          ),
          AppLargeText(text: "By Rella",color: Colors.grey,size: 39,),
          const SizedBox(height: 20,),
          SizedBox(
            width:250,
            child: AppLargeText(text: "Make your social media accounts standout ",size: 25,),
          ),
           const SizedBox(
            height: 30,
          ),
