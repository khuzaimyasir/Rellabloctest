...
import 'package:online_shop_app/style/style.dart';
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          _IconButton(
            icon: const IconToText(Icons.contact_page_rounded, size: SysSize.iconBig - 4),
            text: '4213',
            onTap: onComment,
          ),
          _IconButton(
            icon: const IconToText(Icons.facebook, size: SysSize.iconBig),
            text: '346',
            onTap: onShare,
          ),
          Container(
