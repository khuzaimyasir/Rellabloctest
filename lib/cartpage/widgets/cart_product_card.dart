...
class _CartProductCardState extends State<CartProductCard> {
  final cubit = Modular.get<CartkysCubit>();
  // diff in spot
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: BlocBuilder<CartkysCubit, CartkysState>(
              ...
              children: [
                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                          ...
                          width: 100,
                          child: Text(
                            '\$${widget.product.recipeId.length}',
                            style: const TextStyle(
                              fontSize: 18,
                            ),
                          ),
                  ...
                  child: Container(
                    child: IconButton(
                      ...
                      onPressed: () {
                        ...
                        cubit.addingkys(widget.product);
                      },
                    ),
                  ),
                ),
                ...
                Positioned(
                  ...
                  child: Container(
                    child: IconButton(
                      onPressed: () {
                        cubit.decreasekys(widget.product);
                        // make use of setstate
                      },
                      icon: const Icon(
                        Icons.remove_circle,
                ...
                Positioned(
                  ...
                  child: Container(
                    child: IconButton(
                      onPressed: () {
                        cubit.removekys(widget.product);
                        // make use of setstate and remove the widget
                      },
                      icon: const Icon(
